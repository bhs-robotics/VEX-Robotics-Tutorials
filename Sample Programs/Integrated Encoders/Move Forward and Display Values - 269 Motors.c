...
#pragma config(Motor,  port1,           rightMotor,    tmotorVex269_HBridge, openLoop, encoderPort, I2C_1)
#pragma config(Motor,  port10,          leftMotor,     tmotorVex269_HBridge, openLoop, reversed, encoderPort, I2C_2)
