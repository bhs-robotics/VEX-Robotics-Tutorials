...
//
// Short program to demonstrate the VEX LCD and 3-axis accelerometer sensor.
// Takes the accelerometer values and displays them on the VEX LCD screen.
//
//////////////////////////////////////////////////////////////////////////////////////////////
int X_Accel;
int Y_Accel;
...
task main()
{
	...
	wait1Msec(500);  // Wait for the bias values to be calculated
